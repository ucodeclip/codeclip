      ...
      <ul className={styles.AniLinkList}>
        ...
        <li>
          {/*
              <swipe>
              to       : 遷移先
              top      : 重なりの上に来る要素。 exit か entry を指定
              duration : アニメーションの時間
            */}
          <AniLink swipe to="/demo/demo-5/AniLink-2" top="exit" duration={1}>
            【swipe】AniLink-2へ
          </AniLink>
        </li>
        <li>
          {/*
              ...
              duration  : アニメーションの時間
              bg        : 色
              direction : カバー要素の方向。up,down,left,right を指定
            */}
          <AniLink
            cover
            to="/demo/demo-5/AniLink-2"
        ...
        <li>
          {/*
              ...
              duration  : アニメーションの時間
            */}
          <AniLink fade to="/demo/demo-5/AniLink-2" duration={1}>
            【fade】AniLink-2へ
          </AniLink>
        </li>
      </ul>
